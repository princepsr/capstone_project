...
const LinksContainer = ({ setTraining, training }) => (
  <div css={styles} className="linksContainer">
    ...
    >
      <img src={DumbbellBg} alt="dumbbell" /> Free Style Group Training
    </button>
    <button
      className={training === "SecondClass" ? "active" : ""}
      onClick={() => setTraining("SecondClass")}
    >
      <img src={DumbbellBg} alt="dumbbell" /> Cardio Training
    </button>
    <button
    ...
    >
      <img src={DumbbellBg} alt="dumbbell" /> One to One Training
    </button>
